...
SharedPointer<PixelClassifier> UltrasoundInterface::mPixelClassifier;
...
void UltrasoundInterface::execute() {
    ...
    mCurrentImage = cropPort->getNextFrame<Image>();
...
void UltrasoundInterface::transformImageToProbeCenter(){
    ...
    Eigen::Vector3d translation((double)(mCurrentImage->getWidth()*mCurrentImage->getSpacing()(0)/2),0,0); // z=-40
